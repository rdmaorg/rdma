...
INSERT INTO connection_types_gdma2(id, select_get_tables, connection_class, name) VALUES (2,  'select * from information_schema.tables WHERE table_schema=''public''', 'org.postgresql.Driver', 'Postgres 9.6.2 JDBC');
