...
import pageObjects.InsertNewUser_Page;
...
public class InsertUser extends Init{
	...
	String name2= PropertyHandler.getPropretyFrom("src/test/resources/testData/User2.properties", "name");
	String lastName2=PropertyHandler.getPropretyFrom("src/test/resources/testData/User2.properties", "lastName");
	String userName2=PropertyHandler.getPropretyFrom("src/test/resources/testData/User2.properties", "userName");
	String domain2=PropertyHandler.getPropretyFrom("src/test/resources/testData/User2.properties", "domain");
	...
	public void populate_all_fields_on_the_Insert_new_User_form() throws Throwable {
		...
		InsertNewUser_Page insertNewUser= new InsertNewUser_Page(driver);
