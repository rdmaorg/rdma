...
public class DataModule_EditExistingEntry extends Init {
	
	 String mobileID=PropertyHandler.getPropretyFrom("src/test/resources/testData/NewEntry2_DataModule.properties","mobileID");
	 String mobilePrice=PropertyHandler.getPropretyFrom("src/test/resources/testData/NewEntry2_DataModule.properties","mobilePrice");
	 String mobileName=PropertyHandler.getPropretyFrom("src/test/resources/testData/NewEntry2_DataModule.properties","mobileName");
	 String datetime=PropertyHandler.getPropretyFrom("src/test/resources/testData/NewEntry2_DataModule.properties","datetime");
	 String timestamp=PropertyHandler.getPropretyFrom("src/test/resources/testData/NewEntry2_DataModule.properties","timestamp");
