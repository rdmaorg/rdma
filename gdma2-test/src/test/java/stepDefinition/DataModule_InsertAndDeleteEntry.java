...
public class DataModule_InsertAndDeleteEntry extends Init{
	
	 String mobileID=PropertyHandler.getPropretyFrom("src/test/resources/testData/NewEntry_DataModule.properties","mobileID");
	 String mobilePrice=PropertyHandler.getPropretyFrom("src/test/resources/testData/NewEntry_DataModule.properties","mobilePrice");
	 String mobileName=PropertyHandler.getPropretyFrom("src/test/resources/testData/NewEntry_DataModule.properties","mobileName");
	 String datetime=PropertyHandler.getPropretyFrom("src/test/resources/testData/NewEntry_DataModule.properties","datetime");
	 String timestamp=PropertyHandler.getPropretyFrom("src/test/resources/testData/NewEntry_DataModule.properties","timestamp");
