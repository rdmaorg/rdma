-- import-rdma-mssql.sql --
-- RDMA IMPORT SCRIPT --
-- Author: Daniel Serva --

--import users
INSERT INTO [RDMA].[dbo].[users_gdma2]([active], [is_admin], [is_locked], [first_name], [last_name], [username], [user_domain], [user_password])
     SELECT (CASE WHEN [ACTIVE] = 'Y'
			...
			(CASE WHEN [ISLOCKED] = 'Y'
				...
				ELSE 0
			END) AS ISLOCKED,
				[FIRST_NAME], [LAST_NAME], [USERNAME], '', '' FROM [GDMA].[dbo].[GDMA2_USERS];
